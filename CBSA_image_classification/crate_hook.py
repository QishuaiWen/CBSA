...
import numpy as np
from coding_rate import CodingRate
...
if __name__=="__main__":
    ...
    args.add_argument("--checkpoint_path", type=str, default="CKPT/CBT/cbt_small_best.pth.tar")
    ...
    model = Ours_small() # change this if you are not using CRATE_small
    ...
    with torch.no_grad():
        output = model(input['imgs'].to(device))
