...
class Block(nn.Module):
    ...
    def forward(self, x: torch.Tensor, attn_mask: Optional[torch.Tensor] = None, layer_idx=None) -> torch.Tensor:
        # print(layer_idx)
        x = x + self.drop_path1(self.ls1(self.attn(self.norm1(x), attn_mask=attn_mask, layer_idx=layer_idx)))
...
def vit_tiny_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer('vit_tiny_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
# ori: Acc@1 46.588 Acc@5 69.456
# fine-tine: Acc@1 76.87 Acc@5 93.262
# ours: Acc@1 66.4 Acc@5 87.142
# linear attention: Acc@1 73.192 Acc@5 91.338
# hybrid crate+cbt:
# bybrid cbt+crate:
...
def vit_small_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer('vit_small_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
# ori: Acc@1 74.630 Acc@5 92.672
# fine-tune: Acc@1 81.408 Acc@5 96.1
# ours: Acc@ 74.256 Acc@5 91.826
# hybrid crate+cbt:
# bybrid cbt+crate:
